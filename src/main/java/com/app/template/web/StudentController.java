...
public class StudentController {
	...
	@RequestMapping(value = "/printStudent.pdf/{id}")
	public String printStudent(@PathVariable("id") Long studentId, Model model){
		model.addAttribute("student", repository.findById(studentId));
		return "editStudent";
	}
	...
	@RequestMapping(value = "printAllStudent.pdf", method = RequestMethod.GET)
	public String printAllStudent(Model model){
